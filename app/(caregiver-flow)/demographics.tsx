...
const ethnicities = ['Pakistani', 'Indian', 'Bangladeshi', 'Sri Lankan', 'Nepalese', 'Afghan', 'Bhutanese', 'Maldivian', 'Arab', 'Kurdish', 'No Preference'];
const languages = ['Urdu', 'Turkish', 'Arabic', 'Hindi', 'Kurdish', 'Punjabi', 'Gujarati', 'Bangla', 'Balochi', 'Farsi', 'Dari', 'Pashto', 'Oriya', 'Bhojpuri', 'Sindhi', 'Singhalese', 'Marathi', 'Tamil', 'Telugu', 'Malayalam', 'Kannada', 'Nepali', 'Assamese', 'Magahi', 'No Preference'];
const countries = ['Pakistan', 'India', 'Bangladesh', 'Nepal', 'Bhutan', 'Sri Lanka', 'Afghanistan', 'Maldives', 'Palestine', 'Lebanon', 'Iraq', 'Syria', 'UAE', 'Saudi Arabia', 'Qatar', 'Kuwait', 'Yemen', 'Libya', 'Bahrain', 'Jordan', 'Djibouti', 'Oman', 'Tunisia', 'Somalia', 'Algeria', 'Morocco', 'Chad', 'No Preference'];

export default function CaregiverDemographicsScreen() {
  ...
  const handleContinue = () => {
    if (canContinue) {
      router.push('/(caregiver-flow)/experience');
    }
  };
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>
          This helps families find caregivers who match their preferences
        </Text>
      </View>
      ...
      {renderSection('Country of Origin', countries, 'country')}
